...
public class PathSegmentCollection : FreezableCollection<PathSegment> {
  internal new static PathSegmentCollection CreateProxy(IntPtr cPtr, bool cMemoryOwn) {
    return new PathSegmentCollection(cPtr, cMemoryOwn);
  }

  internal PathSegmentCollection(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }
  ...
  protected override IntPtr CreateCPtr(Type type, out bool registerExtend) {
    ...
    return NoesisGUI_PINVOKE.new_PathSegmentCollection();
  }
