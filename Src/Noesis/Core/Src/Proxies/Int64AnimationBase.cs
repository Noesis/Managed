...
public abstract class Int64AnimationBase : AnimationTimeline {
  internal Int64AnimationBase(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }

  internal static HandleRef getCPtr(Int64AnimationBase obj) {
  ...
  protected internal abstract long GetCurrentValueCore(long defaultOriginValue, long defaultDestinationValue, AnimationClock animationClock);

  internal new static IntPtr Extend(string typeName) {
    return NoesisGUI_PINVOKE.Extend_Int64AnimationBase(Marshal.StringToHGlobalAnsi(typeName));
  }
}
