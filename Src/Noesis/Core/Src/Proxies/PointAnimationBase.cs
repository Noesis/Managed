...
public abstract class PointAnimationBase : AnimationTimeline {
  internal PointAnimationBase(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }

  internal static HandleRef getCPtr(PointAnimationBase obj) {
  ...
  protected internal abstract Point GetCurrentValueCore(Point defaultOriginValue, Point defaultDestinationValue, AnimationClock animationClock);

  internal new static IntPtr Extend(string typeName) {
    return NoesisGUI_PINVOKE.Extend_PointAnimationBase(Marshal.StringToHGlobalAnsi(typeName));
  }
}
