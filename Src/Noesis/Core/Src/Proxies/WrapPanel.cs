...
public class WrapPanel : Panel {
  ...
  private void MeasureOverrideHelper(Size availableSize, ref Size desiredSize) {
    NoesisGUI_PINVOKE.WrapPanel_MeasureOverrideHelper(swigCPtr, ref availableSize, ref desiredSize);
  }

  private void ArrangeOverrideHelper(Size finalSize, ref Size renderSize) {
    NoesisGUI_PINVOKE.WrapPanel_ArrangeOverrideHelper(swigCPtr, ref finalSize, ref renderSize);
  }
