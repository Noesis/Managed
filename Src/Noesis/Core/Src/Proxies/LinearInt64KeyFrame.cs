...
public class LinearInt64KeyFrame : Int64KeyFrame {
  internal new static LinearInt64KeyFrame CreateProxy(IntPtr cPtr, bool cMemoryOwn) {
    return new LinearInt64KeyFrame(cPtr, cMemoryOwn);
  }

  internal LinearInt64KeyFrame(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }
  ...
  protected override IntPtr CreateCPtr(Type type, out bool registerExtend) {
    ...
    return NoesisGUI_PINVOKE.new_LinearInt64KeyFrame();
  }
