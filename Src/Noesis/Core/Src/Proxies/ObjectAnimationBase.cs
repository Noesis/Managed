...
public abstract class ObjectAnimationBase : AnimationTimeline {
  internal ObjectAnimationBase(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }

  internal static HandleRef getCPtr(ObjectAnimationBase obj) {
  ...
  protected internal abstract object GetCurrentValueCore(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock);

  internal new static IntPtr Extend(string typeName) {
    return NoesisGUI_PINVOKE.Extend_ObjectAnimationBase(Marshal.StringToHGlobalAnsi(typeName));
  }
}
