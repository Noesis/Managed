...
public class PointCollection : BoxedFreezableCollection<Point> {
  internal new static PointCollection CreateProxy(IntPtr cPtr, bool cMemoryOwn) {
    return new PointCollection(cPtr, cMemoryOwn);
  }

  internal PointCollection(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }
  ...
  protected override IntPtr CreateCPtr(Type type, out bool registerExtend) {
    ...
    return NoesisGUI_PINVOKE.new_PointCollection();
  }
