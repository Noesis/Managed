...
public abstract class SizeAnimationBase : AnimationTimeline {
  internal SizeAnimationBase(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }

  internal static HandleRef getCPtr(SizeAnimationBase obj) {
  ...
  protected internal abstract Size GetCurrentValueCore(Size defaultOriginValue, Size defaultDestinationValue, AnimationClock animationClock);

  internal new static IntPtr Extend(string typeName) {
    return NoesisGUI_PINVOKE.Extend_SizeAnimationBase(Marshal.StringToHGlobalAnsi(typeName));
  }
}
